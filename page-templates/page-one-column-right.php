<?php 
    // Template Name: Undersida en kolumn med undernavigering till höger
...
<?php
    ...
    if (have_posts()) :
        ...
        while (have_posts()) :
                ...
                the_post();
?>
    <h1 id="h1-left" class="h1-articles">
        <?php 
    ...
    <div class="column">
        <!-- Undernavigering -->
        <div class="subnav" id="subnav-right">
            <?php
        ...
        <!-- Inlägg -->
        <article id="post-content-left" class="post-content">
